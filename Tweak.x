...
=======
//地区归属数据(21年的数据，可以自行更新)
NSDictionary *cityCodeToNameMapping = @{
@"340000": @"安徽",
@"110000": @"北京",
@"500000": @"重庆",
@"350000": @"福建",
...
>>>>>>> 09d97420cc942df71bd690987ca02721a002c972
...
-(id)descriptionString {
    //把获取到的地区代码输出为地区名称
    NSString *cityName = getCityNameFromCode(self.cityCode);
